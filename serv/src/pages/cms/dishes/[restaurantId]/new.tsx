...
import { getTitNewDish } from "../../../../messages/dishes"

const NewDishPage: BlitzPage = ({
  notAllowed,
  role,
  restaurants,
  categories,
  ...
  return (
    <CmsNav title={getTitNewDish()} notAllowed={notAllowed} role={role}>
      <Grid
        id={"dishes"}
        main={
          <DishesCardsGrid
        ...
        aside={categories && <DishForm categories={categories} />}
      />
    </CmsNav>
  )
}

NewDishPage.getLayout = (page: ReactNode) => <DishesLayout>{page}</DishesLayout>
